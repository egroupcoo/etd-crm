...
{
    [DbContext(typeof(EtdCrmDbContext))]
    [Migration("20220716205059_Added_DocumentFile_FilePath")]
    partial class Added_DocumentFile_FilePath
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EtdCrm.Domain.Etd.Doctor", b =>
                {
                    ...
                    b.ToTable("EtdDoctor", (string)null);
                });
            ...
            modelBuilder.Entity("EtdCrm.Domain.Etd.Document", b =>
                {
                    ...
                    b.Property<long?>("RequestFormTreatmentId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdDocument", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.DocumentFile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdDocumentFile", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.Note", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdNote", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.NoteSub", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdNoteSub", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.RequestForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdRequestForm", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.RequestFormTreatment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdRequestFormTreatment", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.Treatment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdTreatment", (string)null);
                });

            modelBuilder.Entity("EtdCrm.Domain.Etd.TreatmentSub", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EtdTreatmentSub", (string)null);
                });
            ...
            modelBuilder.Entity("EtdCrm.Domain.Etd.DocumentFile", b =>
                {
                    b.HasOne("EtdCrm.Domain.Etd.Document", "Document")
            ...
            modelBuilder.Entity("EtdCrm.Domain.Etd.NoteSub", b =>
                {
                    b.HasOne("EtdCrm.Domain.Etd.Note", "Note")
                        .WithMany("NoteSubs")
            ...
            modelBuilder.Entity("EtdCrm.Domain.Etd.RequestFormTreatment", b =>
                {
                    b.HasOne("EtdCrm.Domain.Etd.RequestForm", "RequestForm")
                        .WithMany()
                        .HasForeignKey("RequestFormId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EtdCrm.Domain.Etd.Treatment", "Treatment")
                        .WithMany()
